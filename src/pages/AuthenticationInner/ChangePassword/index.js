...
import { changeUserPassword } from '../../../slices/thunks';
import { useEffect } from 'react';
import { useDispatch } from 'react-redux';

const CoverPasswCreate = (props) => {
    document.title = "Create New Password | Simad University";
    ...
    useEffect(() => {
        ...
        if (authUser) {
            ...
            console.log("current id is:", obj.data.user.id);
            setId(obj.data.user.id);
        }
    }, []);
    ...
    const validation = useFormik({
        ...
        onSubmit: (values) => {
            const payload = { ...values, id: id, currentPassword: process.env.REACT_APP_DEFAULT_PASS }
            // console.log("payload is: ", payload)
            dispatch(changeUserPassword(payload, navigate));
        }
    });
    return (
        <React.Fragment>
                                                    ...
                                                    <Form onSubmit={validation.handleSubmit} action="/auth-signin-basic">
                                                        ...
                                                        <div className="mb-3">
                                                            ...
                                                            <div className="position-relative auth-pass-inputgroup mb-3">
                                                                ...
                                                                <Button color="link" onClick={() => setConfirmPasswordShow(!confirmPasswordShow)} className="position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none">
